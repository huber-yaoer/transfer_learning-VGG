...
def train():
    ...
    # print(tigers_x.shape, cats_x.shape)
    # print((tigers_x + cats_x).shape)
    # print(tigers_x[0], cats_x[0], (tigers_x + cats_x)[0])
    # print(tigers_y.shape, cats_y.shape)
    # print((tigers_y + cats_y).shape)
    # print(tigers_y[0], cats_y[0], (tigers_y + cats_y)[0])
    xs = np.concatenate(tigers_x + cats_x, axis=0)
    ys = np.concatenate((tigers_y, cats_y), axis=0)
    # print(xs.shape, ys.shape, len(xs), len(ys))
    # print(xs[0], ys[0])
